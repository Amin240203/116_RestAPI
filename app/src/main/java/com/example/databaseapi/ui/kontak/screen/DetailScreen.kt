...
import com.example.databaseapi.ui.home.screens.OnError
import com.example.databaseapi.ui.home.screens.OnLoading
...
import com.example.databaseapi.ui.PenyediaViewModel as PenyediaViewModel1
...
fun DetailsScreen(
    ...
    navigateBack: () -> Unit,
    detailsViewModel: DetailsViewModel = viewModel(factory = PenyediaViewModel1.Factory)
) {
...
fun DetailStatus(
    ...
    when(kontakUIState) {
        is DetailsKontakUiState.Succes -> {
